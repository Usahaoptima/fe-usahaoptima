    ...
    <div className="container main-container mt-5">
      <div className="row edu-section">
        ...
        <div className="row edu-content">
          <CardEducation
            imageSrc="assets/img/education/categories/money.png"
          ...
          />
          <CardEducation
            imageSrc="assets/img/education/categories/ads.png"
          ...
          />
          <CardEducation
            imageSrc="assets/img/education/categories/law.png"
            alt="Perizinan Bisnis"
